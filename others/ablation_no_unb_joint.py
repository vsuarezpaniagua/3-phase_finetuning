...
if __name__ == '__main__':
    ...
    ThreePhases(encoder, dataset, encoder_path, HYPER,
                list_extra_names=list_extra_names, unbalance="", extra_text="no_unb_joint")
    ...
    torch.cuda.empty_cache()
    ThreePhases(encoder, dataset, encoder_path, HYPER,
                list_extra_names=list_extra_names, unbalance="",
                test_mode=False, long_mode=True, extra_text="no_unb_joint")
