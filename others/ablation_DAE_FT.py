...
# Monkey patch the requests functions
from src.ablations import multiple_training_DAEFT
...
if __name__ == '__main__':
    ...
    torch.cuda.empty_cache()
    multiple_training_DAEFT(encoder, dataset, encoder_path, HYPER,
                            list_extra_names=list_extra_names, test_mode=test_mode)
    #
    # # ##########################################   SNIPS2   ###################################################
    ...
    torch.cuda.empty_cache()
    multiple_training_DAEFT(encoder, dataset, encoder_path, HYPER,
                            list_extra_names=list_extra_names,
                            test_mode=test_mode, long_mode=True)
