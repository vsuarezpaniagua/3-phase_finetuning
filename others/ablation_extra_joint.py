...
# Monkey patch the requests functions
from src.training_functions import ThreePhases
...
if __name__ == '__main__':
    ...
    logging.info("Extra unbalance approach in a loop.")
    logger = logging.getLogger(__name__)
    # Loop over the models
    list_extra_names = []

    # ############################# ---- EXTRA UNBALANCE CORRECTION ---- #############################
    ...
    torch.cuda.empty_cache()
    ThreePhases(encoder, dataset, encoder_path, HYPER,
                list_extra_names=list_extra_names, unbalance="extra", extra_text="extra_joint")
    ...
    torch.cuda.empty_cache()
    ThreePhases(encoder, dataset, encoder_path, HYPER,
                list_extra_names=list_extra_names, unbalance="extra",
                test_mode=False, long_mode=True, extra_text="extra_joint")
